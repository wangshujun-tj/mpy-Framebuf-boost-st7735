...
#lcd = ST7735(160, 80, spi,dc=Pin(2),cs=Pin(15),rst=Pin(0),rot=1,bgr=0)#横屏初始化参数rot，交换红蓝位置用bgr=1
#lcd = ST7735(80, 160, spi,dc=Pin(2),cs=Pin(15),rst=Pin(0),rot=2,bgr=0)#竖屏初始化参数rot，交换红蓝位置用bgr=1
#lcd = ST7735(160, 128, spi,dc=Pin(2),cs=Pin(15),rst=Pin(0),rot=1,bgr=0)#横屏初始化参数rot，交换红蓝位置用bgr=1
lcd = ST7735(128, 160, spi,dc=Pin(2),cs=Pin(15),rst=Pin(0),rot=2,bgr=0)#竖屏初始化参数rot，交换红蓝位置用bgr=1
bl=Pin(4,Pin.OUT)
bl.value(1)
